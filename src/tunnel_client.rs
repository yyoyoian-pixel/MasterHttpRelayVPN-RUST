...
/// perceptible latency to downloads, where the reply from the tunnel-node
/// is the bottleneck, not coalescing.  Uploads and bursty writes still
/// benefit from the adaptive reset: each arriving op resets the step
